...
<div id="pageContainerDivId">
                ...
                <div class="row dependent-{{$i}}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-paper-display">{{ key_exists('dependent', $employee->details) && isset($employee->details['dependent'][$i]['lastname']) ? $employee->details['dependent'][$i]['lastname']['value'] : '' }}</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="dependentFirstName[{{$i}}]" class="form-paper-label">First name:</label>
                                    <div class="form-paper-display">{{ key_exists('dependent', $employee->details) && isset($employee->details['dependent'][$i]['firstname']) ? $employee->details['dependent'][$i]['firstname']['value'] : '' }}</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="dependentMiddleName[{{$i}}]" class="form-paper-label">Middle name:</label>
                                    <div class="form-paper-display">{{ key_exists('dependent', $employee->details) && isset($employee->details['dependent'][$i]['middlename']) ? $employee->details['dependent'][$i]['middlename']['value'] : '' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 form-paper">
                        <div class="form-group">
                            ...
                            <div class="form-paper-display">{{ key_exists('dependent', $employee->details) && isset($employee->details['dependent'][$i]['relationship']) ? $employee->details['dependent'][$i]['relationship']['value'] : '' }}</div>
                        </div>
                    </div>
                    <div class="col-12 form-paper section-divider"></div>
    ...
    {{--                </div>--}}
                ...
                <div class="row" id="scheduleRowDivId">
                    <div class="col-12 form-paper">
                ...
                <div class="row" id="viewHistoryOfTransferDivId">
                    <div class="col-12 form-paper">
                        <div class="btn-group">
...
{{--
                ...
                <div class="fixed-bottom btn-container m-4" id="buttonsDivId">
